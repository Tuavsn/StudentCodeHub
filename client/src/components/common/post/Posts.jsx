...
const Posts = () => {
    ...
    return (
        <>
            <div className="vh-100 w-100" style={{width: "280px", height: "100%", overflowY: "scroll", scrollbarWidth: 'thin', msOverflowStyle: 'thin'}}>
                <div className="d-flex flex-column" style={{maxWidth: "1200px", margin: "auto"}}>
                    ...
                    <div className="card w-100 mt-4">
                        <div className="card-body">
                            ...
                            <p>Còn chờ gì nữa, hãy thử sức với bài tập đầu tiên nhé.</p>
                        </div>
                    </div>
